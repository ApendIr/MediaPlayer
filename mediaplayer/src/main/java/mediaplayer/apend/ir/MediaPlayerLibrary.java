...
import mediaplayer.apend.ir.listner.MediaPlayerProgressCallback;
import mediaplayer.apend.ir.listner.IUserMethods;
import mediaplayer.apend.ir.util.Util;

/** @author Aidan Follestad (afollestad) */


public class MediaPlayerLibrary extends FrameLayout implements IUserMethods,
    ...
    public MediaPlayerLibrary(Context context) {
        super(context);
        init(context, null);
    }

    public MediaPlayerLibrary(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MediaPlayerLibrary(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private MediaPlayerProgressCallback mProgressCallback;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mType=a.getInteger(R.styleable.EasyVideoPlayer_evp_mediaType, AUDIO_TYPE);
    ...
    private void prepareAudio() {
        if ( mSource == null || mPlayer == null || mIsPrepared) return;
    ...
    private void setAlbumArt() {
        ...
        mData.setDataSource(mSource.getPath());
        try{
            if (mData.getEmbeddedPicture()!=null) {
                ...
                mAlbumArt.setImageDrawable(getResources().getDrawable(R.drawable.ic_music_player));
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    @Override
    public void setCallback(@NonNull MediaPlayerCallback callback) {
        mCallback = callback;
    }

    @Override
    public void setProgressCallback(@NonNull MediaPlayerProgressCallback callback) {
    ...
    protected void onFinishInflate() {
        ...
        //audio
        final FrameLayout.LayoutParams albumLp =
                new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        albumLp.gravity = Gravity.CENTER;
        mAlbumArt = new ImageView(getContext());
        addView(mAlbumArt, albumLp);
        ...
        final MediaPlayerLibrary mediaPlayerLibrary = this;
        ...
        if (mControlsDisabled) {
            ...
            mClickFrame.setOnClickListener(
                    new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            toggleControls();
                            mCallback.onClickVideoFrame(mediaPlayerLibrary);
                        }
                    });
        }
