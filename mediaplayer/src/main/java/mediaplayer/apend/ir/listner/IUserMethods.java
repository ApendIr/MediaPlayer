...
public interface IUserMethods {
  ...
  void setCallback(@NonNull MediaPlayerCallback callback);

  void setProgressCallback(@NonNull MediaPlayerProgressCallback callback);

  void setLeftAction(@MediaPlayerLibrary.LeftAction int action);

  void setRightAction(@MediaPlayerLibrary.RightAction int action);
